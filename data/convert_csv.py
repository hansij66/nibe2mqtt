# Based on work from: https://github.com/yozik04/nibe
...
class CSVConverter:
    ...
    def _update_index(self):
        def calculate_number(row):
            ...
            location = int(row["register"])

            # https://control.com/forums/threads/modbus-register-numbering.49844/
            # Deviating a bit from "standard"
            # Register Reference notation with 0-Based Register Address
            # Hence, you dont need to subtract 1 to get the 0-Based Register Address
